...
La página no es en extremo interactiva, aunque sí es visualmente atractiva a través de los colores y la ilustraciones. Aunque se puede considerar como elemento interactivo el hecho de que "vas de la mano" con Eunice y Minji, ellas te cuentan la historia, esto también está ilustrado en los cuadros de texto, que son parecidos a los de un videojuego. 
***
###### No se vuelve monotono a pesar de que hay un claro estilo definido. Por ejemplo, el color de fondo de la página cambia gradualmente mientras bajas por ella, y con esto también cambia el color de la letra, más no la tipografía.
***
...
***
En este caso solo utilizaron tres gráficos para destacar datos que parecen relevantes para enfatizar un cambio repentino y/o muy evidente con respecto a la industria del k-pop.
